      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="card">
            <h2 className="text-2xl font-bold mb-3">
              <span aria-hidden="true" className="mr-2">🤖</span> AI Agents
            </h2>
          ...
          <div className="card">
            <h2 className="text-2xl font-bold mb-3">
              <span aria-hidden="true" className="mr-2">📰</span> Events
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div className="card">
            <h2 className="text-2xl font-bold mb-3">
              <span aria-hidden="true" className="mr-2">🗳️</span> Voting
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div className="card">
            <h2 className="text-2xl font-bold mb-3">
              <span aria-hidden="true" className="mr-2">⛓️</span> Blockchain
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div className="card">
            <h2 className="text-2xl font-bold mb-3">
              <span aria-hidden="true" className="mr-2">🏆</span> Achievements
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div className="card">
            <h2 className="text-2xl font-bold mb-3">
              <span aria-hidden="true" className="mr-2">📊</span> Leaderboard
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
        ...
        <div className="card">
          <h2 className="text-3xl font-bold mb-4">
            <span aria-hidden="true" className="mr-2">🎥</span> Live Stream
          </h2>
